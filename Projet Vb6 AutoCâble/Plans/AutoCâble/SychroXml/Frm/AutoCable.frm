...
Begin VB.Form UserForm2 
   ...
   Begin TabDlg.SSTab SSTab1 
      ...
      Begin OWC10.Spreadsheet Nom 
         Height          =   9735
         Left            =   -74880
         OleObjectBlob   =   "AutoCable.frx":118BF
         TabIndex        =   47
         Top             =   360
         Width           =   17775
      End
      Begin OWC10.Spreadsheet Cont 
         Height          =   9735
         Left            =   -75000
         OleObjectBlob   =   "AutoCable.frx":1282C
         TabIndex        =   46
         Top             =   360
         Width           =   17775
      End
      Begin OWC10.Spreadsheet Fab 
         Height          =   9735
         Left            =   -75000
         OleObjectBlob   =   "AutoCable.frx":12F1F
         TabIndex        =   45
         Top             =   360
         Width           =   17775
      End
      ...
      Begin VB.ComboBox Hab 
         ...
         ForeColor       =   &H00FF00FF&
         Height          =   315
         ItemData        =   "AutoCable.frx":15B0D
         Left            =   -70680
         List            =   "AutoCable.frx":15B0F
         Sorted          =   -1  'True
         TabIndex        =   25
         Top             =   840
         Width           =   2535
      ...
      Begin VB.ComboBox ENC 
         ...
         ForeColor       =   &H00FF00FF&
         Height          =   315
         ItemData        =   "AutoCable.frx":15B11
         Left            =   -61920
         List            =   "AutoCable.frx":15B13
         Sorted          =   -1  'True
         TabIndex        =   22
         Top             =   840
         Width           =   1455
...
ValideConneceteur Me.Conn, Me.Crit.Range("a1").CurrentRegion, Row
Dim aaa
On Error GoTo 0
...
DoEvents
End Sub
Function ValideConneceteur(sheet, RangeSersh As Object, Row)
...
Sql = "SELECT Nomenclature2.LIAI, Nomenclature2.Desigiation, Nomenclature2.App, Nomenclature2.Voie, Nomenclature2.Ref,  "
...
'      MyWorkbook.Application.Visible = False
    Sql = "SELECT NomenclaturFinal.Desigiation, NomenclaturFinal.Famille, NomenclaturFinal.Ref,NomenclaturFinal.RefFour, NomenclaturFinal.Forunisseur, NomenclaturFinal.Qts,  "
...
Dim FileImport  As String
 FileImport = ShershFihier.chargement
 Unload ShershFihier
 If Trim("" & FileImport) <> "" Then
' Extraction FileImport, Me.Conn, Me.Fil, Me.Crit '"Z:\Echange-ENCELADE\Rd\V5 acqui\donné renault\531.LISTE_FIL"
ImporteCatiaV5 FileImport, Conn, Me.Conn, Me.Fil, NumCollonne
 End If
' ImporteCatiaV5  "", "Z:\Echange-ENCELADE\Rd\V5 acqui\donné renault\531.LISTE_FIL", Conn, Fil, NumCollonne
...
'Je  cherche si le code APP existe dans la liste des connecteurs.
        ...
        I = ChercheXls(UCase(Trim("" & sheet.Cells(Row, NumCollonne("filsApp")))), Me.Conn.Range(ChrCollonne("ConCODE_APP") & "1", ChrCollonne("ConCODE_APP") & CStr(Me.Conn.ActiveSheet.Range("a1").CurrentRegion.Rows.Count)), True)
...
'Je  cherche si le code APP2 existe dans la liste des connecteurs.
             I = ChercheXls(UCase(Trim("" & sheet.Cells(Row, NumCollonne("filsApp2")))), Me.Conn.Range(ChrCollonne("ConCODE_APP") & "1", ChrCollonne("ConCODE_APP") & CStr(Me.Conn.ActiveSheet.Range("a1").CurrentRegion.Rows.Count)), True)
...
'    Set Myrange = Me.Crit.ActiveSheet.Range(ChrCollonne("CritCODE_CRITERE") & "1", ChrCollonne("CritCODE_CRITERE") & CStr(Me.Conn.ActiveSheet.Range("a1").CurrentRegion.Rows.Count))
    ...
    Else
        zz = ""
        For Iaa = 0 To UBound(aa) - 1
            I = ChercheXls(UCase(Trim("" & aa(Iaa))), Me.Crit.ActiveSheet.Range(ChrCollonne("CritCODE_CRITERE") & "1", ChrCollonne("CritCODE_CRITERE") & CStr(Me.Crit.ActiveSheet.Range("a1").CurrentRegion.Rows.Count)), True)
            If I <> 0 Then
