...
Begin VB.Form UtilitairesListes 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Listes des Utilitaires :"
   ClientHeight    =   11775
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   15315
   Icon            =   "UtilitairesListes.frx":0000
   LinkTopic       =   "Form1"
   MaxButton       =   0   'False
   MinButton       =   0   'False
   ScaleHeight     =   11775
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.Image Image1 
         Height          =   855
         Left            =   40
         Picture         =   "UtilitairesListes.frx":08CA
         Stretch         =   -1  'True
         Top             =   150
         Width           =   2055
      End
   ...
   Begin OWC.Spreadsheet Spreadsheet1 
      ...
      Width           =   15315
      HTMLURL         =   ""
      HTMLData        =   $"UtilitairesListes.frx":4C71
      DataType        =   "HTMLDATA"
      AutoFit         =   0   'False
   ...
   End
End
Attribute VB_Name = "UtilitairesListes"
...
Me.Command1.Enabled = False
Sql = "UPDATE Utilitaire SET Utilitaire.Sup = True;"
Con.Exequte Sql
...
DoEvents
    Sql = "select Utilitaire.NameBouton from Utilitaire WHERE "
    Sql = Sql & "Utilitaire.NameBouton='" & MyReplace("" & Myrange(i, 1)) & "' "
     Set Rs = Con.OpenRecordSet(Sql)
     If Rs.EOF = False Then
        Sql = "UPDATE Utilitaire SET Utilitaire.NameBouton ='" & MyReplace("" & Myrange(i, 1)) & "',  "
        Sql = Sql & "Utilitaire.Utilitaire  ='" & MyReplace("" & Myrange(i, 2)) & "',  "
        Sql = Sql & "Utilitaire.Sup = False WHERE "
        Sql = Sql & "Utilitaire.NameBouton='" & MyReplace("" & Myrange(i, 1)) & "' "
        
        Con.Exequte Sql
     Else
        Sql = "INSERT INTO Utilitaire ( NameBouton, Utilitaire ) "
...
'        Sql = Sql & "'" & MyReplace("" & MyRange(i, 3)) & "');"
     ...
     End If
Next i
Con.Exequte "DELETE Utilitaire.*, Utilitaire.Sup FROM Utilitaire WHERE Utilitaire.Sup=True;"
...
Set Rs = Con.OpenRecordSet("SELECT Utilitaire.NameBouton, Utilitaire.Utilitaire FROM Utilitaire ORDER BY Utilitaire.NameBouton;")
