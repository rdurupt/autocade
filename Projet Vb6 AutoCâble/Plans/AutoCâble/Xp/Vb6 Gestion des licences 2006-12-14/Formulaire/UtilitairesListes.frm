...
Begin VB.Form UtilitairesListes 
   ...
   Begin OWC.Spreadsheet Spreadsheet1 
      ...
      Width           =   15315
      HTMLURL         =   ""
      HTMLData        =   $"UtilitairesListes.frx":173C
      DataType        =   "HTMLDATA"
      AutoFit         =   0   'False
...
'        Sql = Sql & "'" & MyReplace("" & MyRange(i, 3)) & "');"
     ...
     End If
Next I
Con.Execute "DELETE Utilitaire.*, Utilitaire.Sup FROM Utilitaire WHERE Utilitaire.Sup=True;"
