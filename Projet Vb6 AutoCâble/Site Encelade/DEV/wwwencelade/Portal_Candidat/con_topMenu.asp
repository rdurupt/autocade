...
ReDim Preserve tempSort(3, indx)		
	...
	tempSort(1, indx) = 2000
	tempSort(2, indx) = "Historique"
	
		indx = indx + 1
		ReDim Preserve tempSort(3, indx)		
		tempSort(0, indx) = 2102
		tempSort(1, indx) = 2002
		tempSort(3, indx) = ""
		tempSort(2, indx) = "Commandes"	
		If Session("HisoriqueCLI") = "" Then 
			Session("HisoriqueCLI") = "javascript:parent.frames['main'].location='Contact.asp?mode=EspaceClient&NumFrm=1'"
		end if
		tempSort(3, indx) =  Session("HisoriqueCLI") 
		indx = indx + 1
		ReDim Preserve tempSort(3, indx)		
		tempSort(0, indx) = 2202
		tempSort(1, indx) = 2002
		tempSort(2, indx) = "Factures"	
		If Session("FactureCLI") = "" Then 
			Session("FactureCLI") = "javascript:parent.frames['main'].location='Contact.asp?mode=EspaceClient&NumFrm=1&ModeFacture=Ok'"
		end if
		tempSort(3, indx) =  Session("FactureCLI") 
...
if session("candidat_UserType") = "Administrator" then	
	...
	indx = indx + 1
	ReDim Preserve tempSort(3, indx)		
	tempSort(0, indx) = 3007
	tempSort(1, indx) = 3004
	tempSort(2, indx) = "Facture"
	tempSort(3, indx) =  "javascript:parent.frames['main'].location='Contact.asp?mode=Historiques&ModeFacture=Ok'"

	
	indx = indx + 1
	ReDim Preserve tempSort(3, indx)		
	tempSort(0, indx) = 3010
	tempSort(1, indx) = 3000
    	tempSort(2, indx) = "FOURNISEUR"
	tempSort(3, indx) = ""
		

			indx = indx + 1
			ReDim Preserve tempSort(3, indx)		
			tempSort(0, indx) = 3030
			tempSort(1, indx) = 3010
			tempSort(2, indx) = "COMANDE GROUPEE"
			tempSort(3, indx) = "javascript:parent.frames['main'].location='Contact.asp?mode=ListeCommandGroupee'"

	indx = indx + 1
	ReDim Preserve tempSort(3, indx)		
	tempSort(0, indx) = 3040
	tempSort(1, indx) = 3000
	tempSort(2, indx) = "ETATS"
	tempSort(3, indx) = ""
		indx = indx + 1
		ReDim Preserve tempSort(3, indx)		
		tempSort(0, indx) = 3050
		tempSort(1, indx) = 3040
		tempSort(2, indx) = "HISTORIQUE"
		tempSort(3, indx) = "javascript:parent.frames['main'].location='Contact.asp?mode=HisoriqueEtat'"
     
      sql="SELECT T_Etats_Titre.MenuName, T_Etats_Titre.Id "
     sql=sql & "FROM T_Etats_Titre "
       sql=sql & "ORDER BY T_Etats_Titre.MenuName;"
	...
	while Rs.eof=false
		...
		ReDim Preserve tempSort(3, indx)		
		tempSort(0, indx) = indexM
		tempSort(1, indx) = 3040
		tempSort(2, indx) = "" &  Rs("MenuName")
		tempSort(3, indx) = "javascript:parent.frames['main'].location='Contact.asp?mode=GenerateurEtat&Id=" & rs("Id") & "'"
	indexM=indexM+1
		Rs.movenext
	wend
