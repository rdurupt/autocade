...
'		response.write (SQL)
	...
	Set Portal = Server.CreateObject(Session("PortalComObject") & ".Portal")
		...
		<tr>
			...
			<tr class="trEntete">
				...
				<td class="texttrEntete" align="center"><%=Portal.GetDefault("EcomPathImages","../euxia/images/icones")%></td>
			</tr>
			<tr>
			...
			%>
				<tr align="center" class="smalltext">
					...
					<td>
						<img src="<%=Portal.GetDefault("EcomPathImages","../euxia/images/icones") & cur("Chemin")%>">&nbsp;&nbsp;
						[<a href="javascript:suppr(<%=cur(0)%>)">Supprimer</a>-<a href="javascript:modif(<%=cur(0)%>)">Mise à Jour</a>]
					</td>
				</tr>
				<%
				cur.movenext
	...
	Portal.Pr(Portal.ViewBasPage(0,"80%","center"))
