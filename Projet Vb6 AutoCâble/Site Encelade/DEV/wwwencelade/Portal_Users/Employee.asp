...
Public Function chtOrganization()
    ...
    '******** TitleBar
    pr ("<table width='100%' border='2' bgcolor='" & Session("TitleBarColor") & "' cellpadding='1' cellspacing='0'>")
    pr ("<tr valign='bottom'>")
    pr ("<td>")
...
Public Function modUser()
    ...
    If Request("sub") = "lst" Then
        ...
        '***************  TitleBar
        pr ("<table border='2' width='100%' bgcolor='" & TitleBarColor & "' cellpadding='1' cellspacing='0'><tr><td>")
...
public function modLogon()
	...
	elseif Request("sub") = "chgpass" then
		...
		pr ("<table bgcolor='silver' border='1' cellspacing='1' bordercolor='gray'>")
