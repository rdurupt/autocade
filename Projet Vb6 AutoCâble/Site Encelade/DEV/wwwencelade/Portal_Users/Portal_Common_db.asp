...
sub CheckAdminRights
	If session("ADMIN")<>1 then
				...
				Response.write ("<THead>Session expirée ...<Br>Vous devez vous ré-identifier<Br><H2><a href='../Portal_ASP/Portal_login.asp' target=_top>Cliquez ici</a>")
				Response.end
	end if
end sub 
...
End sub
	 ...
	 if Session("USERId")=0 then
		Response.write ("<THead>Session expirée ...<Br>Vous devez vous ré-identifier<Br><H2><a href='../Portal_ASP/Portal_login.asp' target=_top>Cliquez ici</a>")
		Response.end
		'Response.Redirect("../Portal_ASP/Portal_login.asp")
    end if
