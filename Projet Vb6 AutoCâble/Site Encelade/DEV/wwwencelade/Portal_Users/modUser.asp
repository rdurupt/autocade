...
<%  
    ...
    If Request("mode") = "web_lst" Then
        ...
        '***************  TitleBar
        pr ("<table border='2' width='100%' bgcolor='" & GetUserDefault(Session("web_UserID"),"usr_bgcolor","#678DB8") & "' cellpadding='1' cellspacing='0'><tr><td>")
    ...
    If Request("mode") = "frm" Then
        ...
        pr ("<body background='../Portal_Html/Images/Background.asp' onLoad='document.frm.FirstName.focus()'>")
            
		
        '***************  TitleBar
        pr ("<table border='2' width='100%' bgcolor='" & GetUserDefault(Session("web_UserID"),"usr_bgcolor","navy") & "' cellpadding='1' cellspacing='0'><tr><td>")
        pr ("<table border='0' width='100%' cellpadding='1' cellspacing='0'>")
        pr ("<tr valign='bottom'>")
        pr ("<td align='left' nowrap>")
