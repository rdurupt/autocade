...
<body background="Background.asp" bgcolor="#F5F7FE">

<% Call GetMenu() %>

<% '****** Header ***** %>
<table width="100%" border="0" bgcolor="<%= GetUserDefault(Session("web_UserID"),"emp_bgcolor","#678DB8") %>" cellpadding="0" cellspacing="0">
<tr>
<td>
