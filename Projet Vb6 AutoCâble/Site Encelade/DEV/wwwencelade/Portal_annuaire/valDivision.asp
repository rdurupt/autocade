...
function javDelete(ID) {
	if (confirm("Delete division?")) {
		location.href = "subDivision.asp?subAction=Delete&DivisionID=" + ID
	} else {
		return
	}
}
...
<font SIZE="4" COLOR="WHITE">&nbsp;Validation Table: Divisions</font>
</th>
<form name="frm" action="subDivision.asp">
<td align="right">
...
<td ALIGN="Left" BGCOLOR="SILVER"><font SIZE="-1"><b>Division</b></font></td>
...
<% do while not RS1.EOF %> 
	...
	<td width="25" align="center" BGCOLOR="White"><a href="javascript:javDelete(<%= RS1("DivisionID") %>)"><img src="delete.gif" border="0" WIDTH="10" HEIGHT="8"></a>&nbsp;</td>
	<td bgcolor="White" nowrap><font SIZE="-1"><input type="text" name="lst" size="40" value="<%= RS1("Division") %>"></font></td>
	</tr>
	<% RS1.MoveNext %>
<% loop %>
